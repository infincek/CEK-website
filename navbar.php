		<div id="header">
				...
				<div class="top  hide-on-med-and-down">
					<div class="row">
						...
						<div class="col address item s6 m2">
							...
							<p>
								<span>Mail</span>
								<span><a href="mailto:cekcape@gmail.com">cekcape@gmail.com</a></span>
							</p>
						</div>
					</div>
				</div>
			...
			<ul class="sidenav" id="mobile">
	        	...
	        	<li><a class="subheader">Address</a></li>
	        	<li><p>KIDANGOOR SOUTH P.O <br>	KOTTAYAM – 686 583</p></li>
	        	<li><a class="subheader">Mail</a></li>
